...
public class TerminalAccessibilityDelegate extends View.AccessibilityDelegate {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull View host, @NonNull AccessibilityNodeInfo info) {
        ...
        if (mTerminalView.mTermSession != null) {
            extra.putString(EXTRA_ACCESSIBILITY_NODE_TYPE, "terminal");
            extra.putInt(EXTRA_TERMINAL_CURSOR_COL, mTerminalView.mTermSession.getCursorCol());
            extra.putInt(EXTRA_TERMINAL_CURSOR_ROW, mTerminalView.mTermSession.getCursorRow());
            mTerminalView.mClient.logInfo(LOG_TAG, "col=" + mTerminalView.mTermSession.getCursorCol() + ", row=" + mTerminalView.mTermSession.getCursorRow());
        }
